    ...
    <>
      <nav className="sticky-navbar">
        <div className="nav-main">
          ...
          <Link to="/contact" className="contact-us-btn desktop-only">
            Contact Us
          </Link>
          <div className={`nav-links ${isMenuOpen ? 'active' : ''}`}>
            <div className="responsive-nav-tabs">
              <div
                onClick={() => scrollToSection('services')}
                className="our-services"
                style={{ cursor: 'pointer' }}
            ...
            <div className="nav-responsive-btn">
              <Link
                to="/contact"
                className="contact-us-btn mobile-only"
                onClick={handleContactClick}
              >
                Contact Us
              </Link>
              <div className='socials-logos responsive'>
                <a
                ...
                >
                  <div className='facebook-logo'>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M9.33329 9.00004H11L11.6666 6.33337H9.33329V5.00004C9.33329 4.31337 9.33329 3.66671 10.6666 3.66671H11.6666V1.42671C11.4493 1.39804 10.6286 1.33337 9.76196 1.33337C7.95196 1.33337 6.66663 2.43804 6.66663 4.46671V6.33337H4.66663V9.00004H6.66663V14.6667H9.33329V9.00004Z" fill="white" />
                    </svg>
                  </div>
                </a>
                <a
