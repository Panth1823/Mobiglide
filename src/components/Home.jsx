    ...
    <>
      <div className="our-services">
        <div className="industries-header choose">
          ...
          <p>Mobilide provides IT staffing solutions that cater to both short and long term needs. Our professionals are embedded across client locations in India, delivering expertise across various sectors. We understand the critical importance of hiring the right talent, and our services are designed to provide flexible and effective solutions.</p>
        </div>
        <div className="services-container">
          <img src={Services} alt="IT Services Illustration" />
          <div className="top resource">
            <div className="industries-header top">
              <p>Our Efficient Engagement Models</p>
              <h1>Through our deep expertise, we are committed to meeting the staffing needs of product companies, service organizations, and captive centers across diverse industries.</h1>
            </div>
                ...
                <div className="resouce-svg">
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="33" viewBox="0 0 32 33" fill="none">
                    <g clipPath="url(#clip0_68_9)">
                      <path d="M7.61777 28.4157C9.67599 29.9133 12.0984 30.831 14.6323 31.0732C17.1661 31.3154 19.7185 30.8732 22.0232 29.7926C24.3278 28.712 26.3002 27.0327 27.7346 24.9299C29.169 22.8271 30.0127 20.3779 30.1778 17.8379H16.3822L7.61777 28.4157Z" fill="#621A0C" />
                      <path d="M30.1778 16.0603C30.0384 13.7442 29.3345 11.4974 28.1274 9.51588C26.9204 7.53431 25.2469 5.87815 23.2528 4.69185C21.2588 3.50555 19.0047 2.82512 16.6874 2.70992C14.37 2.59473 12.0596 3.04825 9.95771 4.03095C7.85583 5.01364 6.0263 6.49566 4.62868 8.34775C3.23106 10.1998 2.3078 12.3657 1.93941 14.6566C1.57103 16.9474 1.76871 19.2935 2.51522 21.4904C3.26173 23.6873 4.5344 25.6682 6.22222 27.2603L15.5467 16.0603H30.1778Z" fill="#621A0C" />
                    </g>
                    <defs>
                      <clipPath id="clip0_68_9">
                        <rect width="32" height="32" fill="white" transform="translate(0 0.949219)" />
                      </clipPath>
                    </defs>
                  </svg>
                </div>
      ...
      <div className="why-choose-us">
        <div className="industries">
          <div className="industries-header choose">
            ...
            <p>Mobilide is powered by a team of 40+ IT professionals, each rigorously selected and continuously trained to ensure they meet the highest standards. Our commitment to quality and expertise means that we help you reduce costs, streamline processes, and scale efficiently, creating a seamless experience for your team.</p>
          </div>
            ...
            <div className="top chooseUs">
              <div className="industry-card chooseUs">
                ...
                <div className="chooseUs-content">
                  ...
                  <h1>Access to a network of highly trained, adaptable professionals.</h1>
                </div>
              </div>
              <div className="industry-card chooseUs">
                ...
                <div className="chooseUs-content">
                  ...
                  <h1>A structured, transparent process from selection to placement.</h1>
                </div>
              </div>
            </div>
            <div className="mid">
              <div className="industry-card chooseUs">
                ...
                <div className="chooseUs-content">
                  ...
                  <h1>Quick lead times that ensure you have the resources you need, exactly when you need them.</h1>
                </div>
              </div>
              <div className="industry-card chooseUs">
                ...
                <div className="chooseUs-content">
                  ...
                  <h1>Business development and recruitment account managers devoted to understanding and supporting your needs.</h1>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="team-container">
        <img src={Team} alt="Mobilide Team" />
      </div>
      <div className="resource-engagement">
        ...
        <div className="top resource">
          <div className="industries-header top">
            ...
            <h1>We recognize that every business has distinct requirements, which is why we offer flexible resource engagement models to meet your specific goals and adapt to changing needs.</h1>
          </div>
          <div className="card-main">
            <div className="resource-card">
              <div className="resouce-svg">
        ...
        <div className="top resource">
          <div className="industries-header top">
            ...
            <h1>At Mobilide, our approach is grounded in excellence and best practices</h1>
          </div>
          <div className="card-main">
            <div className="resource-card">
              <div className="resouce-svg">
              ...
              <div className="resource-content">
                ...
                <p>Continuous training in technology and soft skills to keep our resources sharp and effective.</p>
              </div>
            </div>
            <div className="resource-card">
              <div className="resouce-svg">
              ...
              <div className="resource-content">
                ...
                <p>A structured process that ensures smooth candidate submission, interview attendance, selection, and deployment.</p>
              </div>
            </div>
            <div className="resource-card">
              <div className="resouce-svg">
                <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
                  <mask id="mask0_68_146" maskUnits="userSpaceOnUse" x="0" y="0" width="27" height="27">
                    <path d="M1.32001 13.9492C1.32001 7.32255 6.69334 1.94922 13.32 1.94922C19.9467 1.94922 25.32 7.32255 25.32 13.9492C25.32 20.5759 19.9467 25.9492 13.32 25.9492C6.69334 25.9492 1.32001 20.5759 1.32001 13.9492Z" fill="white" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M7.98669 13.9494L11.9867 17.9494L18.6534 11.2827" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </mask>
                  <g mask="url(#mask0_68_146)">
                    <path d="M29.32 -2.05078H-2.67999V29.9492H29.32V-2.05078Z" fill="#621A0C" />
                  </g>
                </svg>
              </div>
              <div className="resource-content">
                <h1>Guaranteed SLAs</h1>
                <p>Strict SLAs that help us deliver results within industry-leading lead times.</p>
              </div>
            </div>
          </div>
        </div>
